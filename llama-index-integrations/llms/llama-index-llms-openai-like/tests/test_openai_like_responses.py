...
def test_responses_specific_fields():
    ...
    assert llm.store is True  # Should be set to True when track_previous_responses is True
...
if __name__ == "__main__":
    ...
    assert expected_keys.issubset(kwargs.keys()), f"Missing keys: {expected_keys - kwargs.keys()}"
